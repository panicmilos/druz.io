...
export const Profile: FC = () => {
  ...
  const { data: user } = useQuery([id, result, userService], () => userService.fetch(id || ''), { enabled: !!id });
  const { data: userFriend } = useQuery([id, result, userFriendsService], () => userFriendsService.fetchById(id || ''), { enabled: !!id });
